...
ARCHIVE = Path(
    r"C:\Users\Gebruiker\Desktop\FIFA14-WC-Revival\backups\worldcup-gamehub-test\patch.big.before_wc_test"
)

TARGET = "data/ui/external/ion_fut/components/card.big"

OUT = Path(
    r"C:\Users\Gebruiker\Desktop\FIFA14-WC-Revival\extracted\wc_card\card.big"
)
...
for index, offset, size, name in read_entries(data):
    ...
    raise RuntimeError(
        f"Niet gevonden in patch.big: {TARGET}"
    )
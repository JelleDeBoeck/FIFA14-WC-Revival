...
OUT_DIR = ROOT / "extracted" / "supportnation"

TARGET = "data/ui/external/ion_fut/screens/worldcup/supportnation.big"
...
if not target_blob.startswith(
    ...
    raise RuntimeError(
        f"supportnation payload begint niet met 'chunkzip': "
        f"{target_blob[:16].hex(' ')}"
    )
